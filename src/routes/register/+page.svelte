<script lang="ts">
  ...
  import { connectStdb, register, isConnected, isLoggedIn, actionError } from '$lib/stdb';
  ...
  <div class="w-full max-w-md">
    <div class="bg-[#0f121a] border border-[#1b2230] rounded-2xl p-8">
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-[#e9eefc]">Create an account</h1>
      </div>
      ...
      <form onsubmit={(e) => { e.preventDefault(); handleSubmit(); }} class="space-y-5">
        ...
        <div>
          <label for="username" class="block text-xs font-semibold text-[#8b95a8] uppercase tracking-wide mb-2">
            Username
          </label>
          <input
            id="username"
        ...
        <div>
          <label for="confirmPassword" class="block text-xs font-semibold text-[#8b95a8] uppercase tracking-wide mb-2">
            Confirm Password
          </label>
          <input
            id="confirmPassword"
      ...
      <p class="mt-4 text-sm text-[#8b95a8]">
        ...
        <a href="/login" class="text-[#5865f2] hover:underline">Log in</a>
      </p>
    </div>
  </div>
</div>
